...
Este es un ejercicio simple en el que se crea un componente se le pasan props y tambien se le agrega un estado con el hook useState, el mismo utiliza las siguientes herramientas:
...
```
git clone https://github.com/Diego2997/Ejercicio3React.git
```
